...
# rename counts to counts_conf to fit rest of script
counts_conf <- counts
...
pdf(file = paste0("Sample_Clustering_",tpm,"tpm_all_conf.pdf"), width = 20, height = 4)
par(cex = 0.6);
par(mar = c(0,4,2,0))
...
save(datExpr0, metadata_selected, file=paste0("filtered_leaf_data_ready_for_WGCNA_",tpm,"tpm_all_conf.RData"))
