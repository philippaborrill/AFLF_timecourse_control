...
# setup R correctly
# if in cluster
setwd("/nbi/Research-Groups/NBI/Cristobal-Uauy/PB_AFLF/control_timecourse/TF_analysis/WGCNA/")
...
lnames=load(file="filtered_expVIP_data_ready_for_WGCNA_high_conf_0.5tpm.RData")
...
# plot histogram of module sizes
pdf(file="Number of genes in module mergeCutHeight_0.20.pdf")
par(mfrow=c(1,2))
...
# as 1 pdf (10 pages)
pdf(file="dendrogram_of_module_membership_0.20.pdf", width=6, height=4)
par(mfrow = c(5,2))
...
save(bwnetModuleColors, bwnetModuleLabels, bwnetMEs, bwnetdendrograms, file = 
       "bwnet2_network_components_mergeCutHeight0.20.RData")
...
# write genes with modules to file
write.csv(gene_expr,"genes_with_modules_mergeCutHeight0.20.csv")
