...
source blast+-2.2.28
cd /nbi/Research-Groups/NBI/Cristobal-Uauy/PB_AFLF/control_timecourse/TF_analysis/table_orthologues
blastn -db Triticum_aestivum.TGACv1.cds.all.fa -query o_sativa_orthologues_from_wheat_to_rice_blast.txt -num_threads 1  -max_target_seqs 1 -outfmt 6 -out rice_orthologues_blast_to_wheat.txt
