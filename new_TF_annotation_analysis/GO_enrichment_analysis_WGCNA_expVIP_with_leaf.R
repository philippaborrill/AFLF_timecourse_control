...
module_info <- read.csv(file="Y:\\PB_AFLF\\control_timecourse\\TGAC_kallisto_analysis\\kallisto_results_bootstrap\\results\\6_WGCNA_inc_expVIP_data\\maxP0.1\\genes_with_modules_mergeCutHeight0.25.csv", 
                        header=T)
head(module_info)
dim(module_info)
colnames(module_info[c(1,340,341)])
module_info <- module_info[,c(1,340,341)]
...
out_dir <- "Y:\\PB_AFLF\\control_timecourse\\TGAC_kallisto_analysis\\kallisto_results_bootstrap\\results\\6_WGCNA_inc_expVIP_data\\maxP0.1\\GO_enrichment\\"
